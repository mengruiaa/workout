...
//        final String n = products.get(position).getProduct_name().toString();
//        final String t = products.get(position).getProduct_mainimage();
//        final float m = products.get(position).getProduct_price();
//        final String s =products.get(position).getProduct_link();
//
////        name.setText(n);
////        text.setText(t);
////        money.setText(String.valueOf(m));
////        size.setText(String.valueOf(s));
//        img.setImageResource(Integer.parseInt(products.get(position).getProduct_mainimage()));
