package com.example.jszsandroid.MR.TheFour;
...
import com.example.jszsandroid.ConfigUtil;
import com.example.jszsandroid.MR.entity.Course;
...
public class CourseS extends Fragment {
    ...
    private void getZuiXin() {
        ...
        Request request = new Request.Builder()
                .url(ConfigUtil.SERVER_ADDR + "GetZuiXin")
                .post(reqBody)
                .build();
        //3. 创建CALL对象
