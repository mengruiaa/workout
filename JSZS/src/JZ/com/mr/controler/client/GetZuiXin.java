...
/**
 * Servlet implementation class GetZuiXin
 */
@WebServlet("/GetZuiXin")
public class GetZuiXin extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		System.out.println("yhlnb");
		String sign = reader.readLine();
		List<Course> cs= new CourseService().getCoursesBySign(sign); 
		Gson gson=new Gson();
